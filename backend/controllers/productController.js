...
// @desc    Fetch all products with search, pagination, category and sort
...
const getProducts = asyncHandler(async (req, res) => {
  ...
  const sortOrder = req.query.sort === 'lowest' ? { price: 1 } : req.query.sort === 'highest' ? { price: -1 } : { _id: -1 };

  const queryFilters = { ...keyword, ...categoryFilter };
